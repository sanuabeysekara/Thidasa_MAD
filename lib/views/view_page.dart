...
import 'package:news/models/item_details_general_model.dart';
...
import 'package:news/models/watch_later_model.dart';
...
class _ViewPageState extends ConsumerState<ViewPage> {
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            UserSharedPreferences
                                                .getToken() !=
                                                null
                                                ? customFavoriteButton(itemDetailsTvSeries.itemData!,itemDetailsTvSeries.cid!, itemDetailsTvSeries.is_already_wishlisted!)
                                                : Container()
                                          ],
                                        ),
                                      ), //Title
  ...
  Widget generalShow() {
    return FutureBuilder(
      future: ref.read(itemDetailsProvider).getGeneralDetails(widget.cid),
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ItemDetailsGeneral itemDetailsTvSeries = snapshot.data!;
          ItemModel itemData = itemDetailsTvSeries.itemData ?? ItemModel();
          String coverPhoto = itemData.bannerPhoto ?? "";
          String photo = itemData.coverPhoto ?? "";
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: ListTile(
                                            ...
                                            title: Text("Watch Now",style: TextStyle(fontSize: Sizes.dimen_22),),
                                            onTap: () async {
                                              Navigator.push(
                                                context,
                                                CupertinoPageRoute(builder:
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        padding: EdgeInsets.only(
                                            ...
                                            bottom: 0),
                                        child: ListTile(
                                          trailing: isDownloadLoading?CircularProgressIndicator(color: Colors.white,):Container(child: Text(""),),
                                            leading: Icon(
                                            ...
                                            title: Text("Download Now",style: TextStyle(fontSize: Sizes.dimen_22),),
                                            onTap: () async {
                                              setState(() {
                                                isDownloadLoading = true;
                                              });
                                              await SavedItemsDatabase.instance.create(itemData);
  ...
  Widget customFavoriteButton(ItemModel itemModel,String cid,bool isWishlisted){
    return FavoriteButton(
      ...
      valueChanged: (_isFavorite) async {
        ...
        if (_isFavorite) {
          ...
          ServerResponse serverResponse = await ref.read(httpProvider).addToWishList(map);
          WatchLater watchLater = WatchLater(uid: map['uid'],cid: map['cid'],timeAdded: DateTime.now());

          if (serverResponse.code == 200) {

            flush = Flushbar<bool>(
              title: "Added to Wishlist ",
              message: "The item added to wishlist",
